window.SUPABASE_URL = "https://https://qddjhayaqkdcxqgdriav.supabase.co";
...
// Fill with your project values, then commit.
// For magic link auth, set Supabase Auth -> URL Config -> Redirect URLs to your GitHub Pages domain.
